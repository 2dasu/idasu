      ...
      <div className="content">
          ...
          <div className="content-box">
            ...
            <div className="contents">
              ...
              <p>웹소설〈 즐거운 인생 〉 표지 작업</p>
              <p>웹소설〈 군의관 이계가다 〉 표지 작업</p>
              <p>웹소설〈 해결사 가인 〉 표지 작업</p>
              <p>게임〈 권총소녀 키우기 〉 메인 일러스트 작업</p>
              <p>〈크래프톤〉 미공개 외주 작업</p>
              <p>미공개 웹소설 표지 작업 다수</p>
              <p>미공개 게임 일러스트 작업 다수</p>
              <p>버츄얼 모델 일러스트 작업 15건 이상 </p>
            </div>
          </div>
